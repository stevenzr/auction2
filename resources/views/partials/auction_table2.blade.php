...
<table class="auction-table">
    <tr>
        ...
        <th>@lang('auction_table.status')</th>
    </tr>
    @forelse($auctions as $auction)
        <tr>
            ...
            <td class="bidding-status">
                ...
                @php ($latestBidPrice = 200)

                @php ( $userBidPrice= 100 )

                @if($userBidPrice > $latestBidPrice) @lang('auction_table.winning') @endif
                @if($userBidPrice < $latestBidPrice) @lang('auction_table.losing') @endif
