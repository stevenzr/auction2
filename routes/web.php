...
Route::get('toys','EtcController@toys')->name('toys');
Route::get('electronic','EtcController@electronic')->name('electronic');
Route::get('hobbies','EtcController@hobbies')->name('hobbies');
Route::get('accessories','EtcController@accessories')->name('accessories');
