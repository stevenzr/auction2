...
class EndAuction extends Command
{
    ...
    public function handle()
    {
      ...
      $endedAuctionsWithoutBid = $endedAuctionsWithoutBids->doesntHave('bids')->get();

      foreach($endedAuctionsWithoutBid as $endedAuctionWithoutBids1) {
        $endedAuctionWithoutBids1->status = 'expired';
        $endedAuctionWithoutBids1->save();
